...
class Trainer(object):
    ...
    def __init__(self, model, optimizer, result_path, model_name, tag_to_id, usedataset,
        ...
        self.evaluator = Evaluator(result_path, model_name,usecuda=usecuda).evaluate_fmeasure
    
    def adjust_learning_rate(self, optimizer, lr):
        for param_group in optimizer.param_groups:
            param_group['lr'] = lr
            
    def train_model(self, num_epochs, train_data, test_data, learning_rate,
                    eval_train=False, plot_every=20, adjust_lr=False, batch_size = 50):
        ...
        for epoch in range(1, num_epochs+1):
            ...
            for i, index in enumerate(np.random.permutation(len(train_batches))): 
                ...
                # words, tags, wordslen, usecuda=True
        ...
        return losses, all_F,self.model
